...
namespace Sample
{
    public partial class UtilityTools
    {
        /// <summary>Gets the default singleton instance of this tool context.</summary>
        public static UtilityTools Default { get; } = new UtilityTools();
        ...
        public override global::System.Collections.Generic.IReadOnlyList<global::Microsoft.Extensions.AI.AITool> Tools
        {
            get
            {
                ...
                {
                    new Utility_Echo_Tool(),
                    new Utility_EchoInstance_Tool(),
                };
            }
        }

        private sealed class Utility_Echo_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            public override string Name => "echo_static";
            ...
            {
                var serviceType = typeof(global::Sample.Utility);
                var paramTypes = new global::System.Type[] { typeof(string), };
                return serviceType.GetMethod("Echo", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Static, null, paramTypes, null)
                    ?? throw new global::System.InvalidOperationException("Could not locate target method global::Sample.Utility.Echo.");
            }
            ...
            {
                var __arg_message = global::Microsoft.Maui.AI.Attributes.AIToolContext.Helpers.GetRequiredArg<string>(arguments, "message");
                var __result = global::Sample.Utility.Echo(__arg_message);
                return __result;
            }
        }

        private sealed class Utility_EchoInstance_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            private static readonly global::System.Lazy<global::System.Text.Json.JsonElement> s_schema = new(BuildSchema);
            private static readonly global::System.Lazy<global::System.Text.Json.JsonElement?> s_returnSchema = new(BuildReturnSchema);

            public override string Name => "echo_instance";
            public override string Description => string.Empty;
            public override global::System.Text.Json.JsonElement JsonSchema => s_schema.Value;
            public override global::System.Text.Json.JsonElement? ReturnJsonSchema => s_returnSchema.Value;
            ...
            private static global::System.Reflection.MethodInfo GetTargetMethod()
            {
                var serviceType = typeof(global::Sample.Utility);
                var paramTypes = new global::System.Type[] { typeof(string), };
                return serviceType.GetMethod("EchoInstance", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Instance, null, paramTypes, null)
                    ?? throw new global::System.InvalidOperationException("Could not locate target method global::Sample.Utility.EchoInstance.");
            }
                ...
                global::System.Threading.CancellationToken cancellationToken)
            {
                ...
                var __service = __provider.GetRequiredService<global::Sample.Utility>();
                var __arg_message = global::Microsoft.Maui.AI.Attributes.AIToolContext.Helpers.GetRequiredArg<string>(arguments, "message");
