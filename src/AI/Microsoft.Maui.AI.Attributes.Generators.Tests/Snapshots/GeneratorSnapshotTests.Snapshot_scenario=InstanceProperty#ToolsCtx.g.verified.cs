...
namespace Sample
{
    public partial class ToolsCtx
    {
        ...
        private sealed class Svc_Count_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            public override string Name => "current_count";
            public override string Description => "Gets the current count.";
            ...
            private static global::System.Reflection.MethodInfo GetTargetMethod()
            {
                ...
                var prop = serviceType.GetProperty("Count", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Instance)
                    ?? throw new global::System.InvalidOperationException("Could not locate target property global::Sample.Svc.Count.");
                return prop.GetMethod
                    ?? throw new global::System.InvalidOperationException("Property global::Sample.Svc.Count has no getter.");
            }
                ...
                global::System.Threading.CancellationToken cancellationToken)
            {
                var __provider = arguments.Services ?? throw new global::System.InvalidOperationException(
                    "Tool 'current_count' requires services (source type: global::Sample.Svc) but no IServiceProvider was supplied. " +
                ...
                var __service = __provider.GetService<global::Sample.Svc>() ?? throw new global::System.InvalidOperationException(
                    "Tool 'current_count' could not resolve its source type 'global::Sample.Svc' from IServiceProvider. " +
