...
namespace Sample
{
    public partial class ToolsCtx
    {
        ...
        public override global::System.Collections.Generic.IReadOnlyList<global::Microsoft.Extensions.AI.AITool> GetTools(global::System.IServiceProvider serviceProvider)
        {
            ...
            {
                new Svc_Add_Tool(serviceProvider),
            };
        }
        ...
        {
            services.AddSingleton<global::Microsoft.Extensions.AI.AITool>(static sp => new Svc_Add_Tool(sp));
        }
        ...
        {
            services.AddKeyedSingleton<global::Microsoft.Extensions.AI.AITool>(key, static (sp, _) => new Svc_Add_Tool(sp));
        }
        ...
        private sealed class Svc_Add_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            public Svc_Add_Tool(global::System.IServiceProvider? fallback = null)
            {
                _fallback = fallback;
            }
