...
namespace Sample
{
    public partial class ToolsCtx
    {
        ...
        public override global::System.Collections.Generic.IReadOnlyList<global::Microsoft.Extensions.AI.AITool> GetTools(global::System.IServiceProvider serviceProvider)
        {
            ...
            {
                new Svc_Hello_Tool(serviceProvider),
            };
        }
        ...
        {
            services.AddSingleton<global::Microsoft.Extensions.AI.AITool>(static sp => new Svc_Hello_Tool(sp));
        }
        ...
        {
            services.AddKeyedSingleton<global::Microsoft.Extensions.AI.AITool>(key, static (sp, _) => new Svc_Hello_Tool(sp));
        }

        private sealed class Svc_Hello_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            public Svc_Hello_Tool(global::System.IServiceProvider? fallback = null)
            {
                _fallback = fallback;
            }
            ...
            private static global::System.Reflection.MethodInfo GetTargetMethod()
            {
                ...
                return serviceType.GetMethod("Hello", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Instance, null, paramTypes, null)
                    ?? throw new global::System.InvalidOperationException("Could not locate target method global::Sample.Svc.Hello.");
            }
