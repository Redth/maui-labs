...
namespace Sample
{
    public partial class ToolsCtx
    {
        ...
        private sealed class Store_Find_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            {
                var serviceType = typeof(global::Sample.Store);
                var paramTypes = new global::System.Type[] { typeof(string), };
                return serviceType.GetMethod("Find", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Static, null, paramTypes, null)
                    ?? throw new global::System.InvalidOperationException("Could not locate target method global::Sample.Store.Find.");
            }
        ...
        private sealed class Store_Items_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            {
                var serviceType = typeof(global::Sample.Store);
                var prop = serviceType.GetProperty("Items", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Static)
                    ?? throw new global::System.InvalidOperationException("Could not locate target property global::Sample.Store.Items.");
                return prop.GetMethod
                    ?? throw new global::System.InvalidOperationException("Property global::Sample.Store.Items has no getter.");
            }
