...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        // ── AI Tools (source-generated, keyed) ──────────────────────
        //
        // Two tool contexts registered under different DI keys. Each page
        // resolves only the tools for its agent via
        // sp.GetKeyedServices<AITool>("browse"|"manage").
        builder.Services.AddAITools<CatalogTools>("browse");
        builder.Services.AddAITools<GardenManagementTools>("manage");
