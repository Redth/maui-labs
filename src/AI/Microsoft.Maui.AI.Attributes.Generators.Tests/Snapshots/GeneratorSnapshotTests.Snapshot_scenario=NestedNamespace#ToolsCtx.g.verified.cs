...
namespace Sample.Inner.Deeper
{
    public partial class ToolsCtx
    {
        ...
        private sealed class Svc_Do_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            {
                var serviceType = typeof(global::Sample.Inner.Deeper.Svc);
                ...
                return serviceType.GetMethod("Do", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Instance, null, paramTypes, null)
                    ?? throw new global::System.InvalidOperationException("Could not locate target method global::Sample.Inner.Deeper.Svc.Do.");
            }
                ...
                global::System.Threading.CancellationToken cancellationToken)
            {
                var __provider = arguments.Services ?? throw new global::System.InvalidOperationException(
                    "Tool 'Do' requires services (source type: global::Sample.Inner.Deeper.Svc) but no IServiceProvider was supplied. " +
                ...
                var __service = __provider.GetService<global::Sample.Inner.Deeper.Svc>() ?? throw new global::System.InvalidOperationException(
                    "Tool 'Do' could not resolve its source type 'global::Sample.Inner.Deeper.Svc' from IServiceProvider. " +
