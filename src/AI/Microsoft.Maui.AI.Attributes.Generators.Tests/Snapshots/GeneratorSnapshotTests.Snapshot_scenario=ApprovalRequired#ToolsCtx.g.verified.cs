...
namespace Sample
{
    public partial class ToolsCtx
    {
        ...
        public override global::System.Collections.Generic.IReadOnlyList<global::Microsoft.Extensions.AI.AITool> GetTools(global::System.IServiceProvider serviceProvider)
        {
            ...
            {
                new global::Microsoft.Extensions.AI.ApprovalRequiredAIFunction(new Svc_Dangerous_Tool(serviceProvider)),
            };
        }
        ...
        {
            services.AddSingleton<global::Microsoft.Extensions.AI.AITool>(static sp => new global::Microsoft.Extensions.AI.ApprovalRequiredAIFunction(new Svc_Dangerous_Tool(sp)));
        }
        ...
        {
            services.AddKeyedSingleton<global::Microsoft.Extensions.AI.AITool>(key, static (sp, _) => new global::Microsoft.Extensions.AI.ApprovalRequiredAIFunction(new Svc_Dangerous_Tool(sp)));
        }

        private sealed class Svc_Dangerous_Tool : global::Microsoft.Extensions.AI.AIFunction
        {
            ...
            public Svc_Dangerous_Tool(global::System.IServiceProvider? fallback = null)
            {
                _fallback = fallback;
            }
            ...
            private static global::System.Reflection.MethodInfo GetTargetMethod()
            {
                ...
                return serviceType.GetMethod("Dangerous", global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.Instance, null, paramTypes, null)
                    ?? throw new global::System.InvalidOperationException("Could not locate target method global::Sample.Svc.Dangerous.");
            }
